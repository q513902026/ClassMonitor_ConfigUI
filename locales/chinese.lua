...
L.PluginDescription_AURABAR = "在一个监视条上显示Buff/Debuff的堆叠数量、最大值和持续时间"
...
L.PluginShortDescription_BANDITSGUILE = select(1, GetSpellInfo(84654)) -- 盗匪之诈
L.PluginDescription_BANDITSGUILE = "显示战斗贼盗匪之诈的堆叠层数"
L.PluginShortDescription_STAGGER =  select(1, GetSpellInfo(124255)) -- 醉拳
